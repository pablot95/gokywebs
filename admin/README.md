...
- En **Mantenimiento → Plan mensual** hay una sola tabla para suscriptores de Mercado Pago y clientes cargados a mano. Todas las filas muestran WhatsApp, dominio, estado, cambios del mes y el botón de facturación. Los datos de contacto se toman del suscriptor, del cliente vinculado o del registro de Completados; el dominio también se puede cargar al editar un cliente.
