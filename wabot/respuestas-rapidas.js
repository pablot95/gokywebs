...
(() => {
  ...
  const grupos = {
    ...
    'Cobros': [
      ...
      'El resto del plan anual se abona al entregar la web. Te aviso cuando esté lista.',
      'Para el plan mensual, te comparto el enlace de pago y te confirmo cuando quede activo.',
      'Se cumple el año de tu web y toca renovar el plan anual. ¿Te paso los datos para el pago?'
    ],
    'Seguimiento': [
