...
caso('los tres pasos arrancan con la demo gratis', strpos($r[1] ?? '', '1. Te hacemos una demo gratis') !== false);
...
caso('quien la pidió al entrar recibe los tres pasos SIN la pregunta y el formulario atrás',
    count($r) === 3 && mb_stripos($r[1], 'Así trabajamos') !== false && strpos($r[1], 'Querés que preparemos') === false && tiene_form([$r[2] ?? '']),
