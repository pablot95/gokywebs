...
$esperados = [
    'landing' => ['un sitio profesional donde presentes tu negocio, muestres tus servicios o trabajos y te escriban directo a tu WhatsApp', '$120.000', '$20.000'],
    'inmobiliaria' => ['una web inmobiliaria donde publiques tus propiedades con fotos y fichas completas, con buscador por zona, tipo y precio', '$180.000', '$30.000'],
    'elearning' => ['una plataforma donde vendas tus cursos, con los videos organizados, acceso propio para cada alumno y cobro online', '$200.000', '$30.000'],
];
