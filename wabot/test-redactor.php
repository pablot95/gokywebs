...
$GLOBALS['WABOT_TEST_REDACTOR'] = function ($msg, $base, $conv, $cfg) {
    return "Mirá, para lo tuyo va una Landing: \$160.000 por todo el desarrollo, o en 3 pagos de \$56.000. Todo el detalle está acá: gokywebs.com/presupuestos/Landing y te hacemos un prediseño gratis antes de que decidas.";
};
$c = convNueva();
...
caso('modo natural → manda la versión redactada del primero',
    ...
    && strpos($r[0], '$160.000') !== false && strpos($r[0], '$56.000') !== false);
...
caso('"un una" se rechaza y cae al texto fijo',
    wabot_validar_redaccion('Para lo tuyo iría un una página a medida: $160.000, en 3 pagos de $56.000. gokywebs.com/presupuestos/Landing', $basePrecio, $cfg) === null);
caso('"la un" también',
    wabot_validar_redaccion('Te queda la un página a medida: $160.000, en 3 pagos de $56.000. gokywebs.com/presupuestos/Landing', $basePrecio, $cfg) === null);
caso('pero una redacción bien escrita sigue pasando',
    wabot_validar_redaccion('Para lo tuyo va una página a medida: $160.000, o en 3 pagos de $56.000. gokywebs.com/presupuestos/Landing', $basePrecio, $cfg) !== null);
caso('y "una web" con un artículo solo no se confunde con el error',
    wabot_validar_redaccion('Te armamos una web a medida por $160.000, en 3 pagos de $56.000. gokywebs.com/presupuestos/Landing', $basePrecio, $cfg) !== null);
