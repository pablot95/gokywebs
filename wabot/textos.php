...
function wabot_textos_default() {
    ...
    'info' => [
        'proceso' => "Primero mirás trabajos reales y elegís uno o dos modelos como referencia. Después elegís pago único —con seña y saldo al entregar— o abono mensual, completás el formulario y coordinamos el arranque. La web suele quedar lista en unos 7 días desde que arrancamos y nos pasás el contenido.\nEl valor depende del tipo de web: contame a qué te dedicás y te lo paso.",
    ...
    'pago_antes_o_despues' => 'Para arrancar elegís una de las dos formas: la seña del pago único o la primera mensualidad del abono. Antes podés mirar trabajos reales y elegir uno o dos modelos en gokywebs.com/modelos/.',
