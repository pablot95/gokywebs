const PRODUCTS = [
  ...
  { id: 10, name: "Long Sleeve Noite", category: "Remeras", price: 42900, image: "images/product-long-black.png", badge: "", description: "Manga larga oversize con puño suave y largo extendido.", sizes: ["S", "M", "L"], tags: "manga larga negra noite" },
...
$$("[data-jump-category]").forEach((link) => link.addEventListener("click", () => {
