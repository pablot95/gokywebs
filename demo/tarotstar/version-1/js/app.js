/* V1 "Luz" — render + interacción. Usa data.js + core.js. */
...
function cardHTML(c) {
  ...
  return '<article class="c-card '+c.color+'" data-animate>'+
    ...
    '<div class="c-body"><h3><a href="'+BASE+'curso/?id='+c.id+'">'+esc(c.titulo)+'</a></h3>'+
    '<p class="c-sub">'+esc(c.subtitulo)+'</p>'+
    '<div class="c-meta"><span>'+esc(c.nivel)+'</span><i></i><span>'+esc(c.duracion)+'</span><i></i><span>'+totalClases(c)+' clases</span></div>'+
