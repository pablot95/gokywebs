(function () {
  ...
  function initMap() {
    ...
    L.circle([-34.6037, -58.3816], { radius: 42000, color: '#ffc20e', weight: 2, fillColor: '#ffc20e', fillOpacity: 0.08 }).addTo(map);
    const icon = L.divIcon({ className: '', html: '<div style="width:22px;height:22px;border-radius:50%;background:#ffc20e;border:3px solid #0f1d2e;box-shadow:0 3px 10px rgba(0,0,0,.5)"></div>', iconSize: [22, 22], iconAnchor: [11, 11] });
